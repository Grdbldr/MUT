...
!*************************************************************************old plot_data declarations  end here
   ...
   subroutine ProcessTecplot(FnumMUT) !--- Process Tecplot instructions
    ...
    subroutine Tecplot_hsplot2012
        ...
        type(HGHTecplotdomain) Global  
        type(HGHTecplotdomain) MyPm  
        type(HGHTecplotdomain) MyDual
        type(HGHTecplotdomain) MyFrac
        type(HGHTecplotdomain) MyOlf 
        type(HGHTecplotdomain) MyWell 
        type(HGHTecplotdomain) MyChan 
        type(HGHTecplotdomain) MyTile 
    ...
    subroutine DomainCreate(NewDomain,NewDomainLable,global)
        ...
        implicit none
        type(HGHTecplotdomain) NewDomain
        type(HGHTecplotdomain) global
